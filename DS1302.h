...
#define DS1302_IO_PIN     11    // Arduino pin for the Data I/O
#define DS1302_CE_PIN     12    // Arduino pin for the Chip Enable
...
// --------------------------------------------------------
void Update_Date_Time( int dayofmonth, int month, int year, int dayofweek , int hours , int minutes, int seconds ){
